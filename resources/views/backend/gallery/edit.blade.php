    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card"> 
          <div class="card-body">
            ...
            <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('update.photo', $photo->id)}}" >
              @csrf
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control"  name="title" style="color:white;" value="{{$photo->title}}">
                  @error('title')
