    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card"> 
          <div class="card-body">
            ...
            <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('store.video')}}" >
              @csrf
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control"  name="embed_code" style="color:white;">
                    @error('title')
                    <span class="text text-danger">{{$message}}</span>
                    @enderror
                  </div>
