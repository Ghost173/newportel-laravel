...
<div class="content-wrapper">
    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card"> 
          <div class="card-body">
            <h4 class="card-title">gallry Video</h4>

            <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('update.video',$videos->id)}}" >
              @csrf
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control"  name="title" style="color:white;" value="{{$videos->title}}">
                  @error('title')
                ...
                <div class="form-group col-md-12">
                    <label for="exampleInputName1">Emberd code</label>
                    <input type="text" class="form-control"  name="embed_code" value="{{$videos->embed_code}} style="color:white;">
                    @error('title')
                    <span class="text text-danger">{{$message}}</span>
                    @enderror
                  </div>
